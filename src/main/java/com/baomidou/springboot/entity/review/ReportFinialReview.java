...
public class ReportFinialReview {
    ...
    public ReportFinialReview(String hours_desc, String finial_review_add_cnt, String finial_review_add_amt,
                              String finial_review_finish_cnt, String finial_review_finish_amt,
                              String finial_review_refuse_cnt, String finial_review_refuse_amt) {
